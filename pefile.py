...
class PE(object):
    ...
    def pack_msg1(self,a):
        if (a == True):
            print("Both IMAGE_SCN_MEM_WRITE and IMAGE_SCN_MEM_EXECUTE are set, This might indicate a packed executable.\n")
    def pack_msg2(self,b):
        if (b == True):
            print("Imported symbols contain entries typical of packed executables.\n")
